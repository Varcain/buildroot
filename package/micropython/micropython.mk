...
ifeq ($(BR2_PACKAGE_MICROPYTHON_SQLITE),y)
MICROPYTHON_DEPENDENCIES += sqlite
MICROPYTHON_MAKE_OPTS += MICROPYTHON_SQLITE=1
endif

ifeq ($(BR2_PACKAGE_MICROPYTHON_OVE_PROCESS),y)
MICROPYTHON_MAKE_OPTS += MICROPYTHON_OVE_PROCESS=1
endif

ifneq ($(filter y,$(BR2_PACKAGE_MICROPYTHON_SQLITE) $(BR2_PACKAGE_MICROPYTHON_OVE_PROCESS)),)
MICROPYTHON_MAKE_OPTS += \
	USER_C_MODULES=$(TOPDIR)/$(MICROPYTHON_PKGDIR)/usermod
endif
