...
/** Enable log module — the benchmark emits its per-scene CSV summary (Name, CPU%, FPS,
 *  render/flush ms) through LV_LOG, so the console gets a full breakdown, not just the average. */
#define LV_USE_LOG 1
#if LV_USE_LOG
